...
const About = () => {
    return (
        <div className="about-container">
            ...
            <p>
                Chào mừng bạn đến với MARVELLA, nơi mà sự thoải mái gặp gỡ sự sang trọng.
                Đội ngũ của chúng tôi luôn sẵn sàng phục vụ bạn với dịch vụ tốt nhất.
            </p>
            <h2>Đội Ngũ Chúng Tôi</h2>
            <ul>
                <li>
                    <strong>Giám Đốc Khách Sạn:</strong> Trần Thị Yến - Với hơn 15 năm kinh nghiệm trong ngành khách
                    sạn.
                </li>
                <li>
                    <strong>Quản Lý Dịch Vụ Khách Hàng:</strong> Đào Khắc Đạt - Luôn sẵn sàng lắng nghe và đáp ứng nhu
                    cầu của khách hàng.
                </li>
                <li>
                    <strong>Đầu Bếp Chính:</strong> Nguyễn Hoàng Phi Long - Mang đến những món ăn ngon miệng và độc đáo.
                </li>
                <li>
